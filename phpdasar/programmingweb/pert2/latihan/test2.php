        ...
        <table class="table text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center"><input type="text" name="uangditerima" id="uangditerima" class="form-control form-control-sm " style="width: 50%;"></td>
                </tr>
                <tr>
