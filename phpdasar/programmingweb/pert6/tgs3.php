            ...
            <tbody>
                <form action="proses3.php" method="POST">
                    <tr>
                        <td>Buku</td>
                        <td>
                            <input type="text" class="form-control form-control-sm text-center" autocomplete="off" name="hargabuku" id="hargabuku" value="<?= $hrgsatuan[0]; ?>">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>Mouse</td>
                        <td>
                            <input type="text" class="form-control form-control-sm text-center" autocomplete="off" name="hargamouse" id="hargamouse" value="<?= $hrgsatuan[1]; ?>">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>FlashDisk</td>
                        <td>
                            <input type="text" value="<?= $hrgsatuan[2]; ?>" class="text-center form-control form-control-sm" autocomplete="off" name="hargaflashdisk" id="hargaflashdisk">
                        <td>
                    ...
                    <tr>
                        <td>Pulpen</td>
                        <td>
                            <input type="text" value="<?= $hrgsatuan[3]; ?>" class="text-center form-control form-control-sm" autocomplete="off" name="hargapulpen" id="hargapulpen">
                        </td>
                        <td>
