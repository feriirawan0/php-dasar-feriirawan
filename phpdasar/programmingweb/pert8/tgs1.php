...
<body>
    <div class="container m-auto" style="width: 500px;">
        <form action="proses1.php" method="POST">
            <h2 class='display-4'>Function Pertemuan 8</h2>
            <div>
                <ol>
                    <li>Penggunaan IF</li>
            ...
            <div class="form-group">
                <label class="h5">Pilih Materi Yang Ingin Anda Pelajari :</label>
                <input type="text" name="bil1" class="form-control" value="" required>
                <br>
